...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label3->Text = L"Вопрос 3: Какие леса преобладают в беларуси\? ";
			...
			this->checkBox2->Text = L"Смешанные";
			...
			this->checkBox1->Text = L"Лиственные";
